...
- [x] S03-P03-P01 Element Plus 基础设施已落地（`675ebeb`）：Schema adapter + Table/Form/Drawer + 五态 + 高危操作组件；element-plus 已注册（过渡期 layui 共存）。Layui→Element Plus 逐页替换在 S03-P03-P04/P05 推进。
