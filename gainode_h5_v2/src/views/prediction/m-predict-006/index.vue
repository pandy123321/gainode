...
<template>
  <main class="restricted-page">
    <header class="page-header">
      <h1>{{ t('page.m_predict_006.title') }}</h1>
      <DataStateBadge page-id="M-PREDICT-006" />
    </header>
    <FiveStateContainer state="restricted" :restricted-message="t('page.m_predict_006.restricted')">
      <p class="hint">{{ t('page.m_predict_006.description') }}</p>
    </FiveStateContainer>
    <div class="actions">
