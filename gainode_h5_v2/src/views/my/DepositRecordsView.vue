...
onMounted(async () => {
  const res = await WalletApi.getDepositRecords()
...
.record-item {
  ...
  .item-right {
    text-align: right;
    strong { display: block; font-size: 15px; font-weight: 700; color: $green; }
