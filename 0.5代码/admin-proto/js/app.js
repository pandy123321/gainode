var App = {
  ...
  renderSidebar:function(){
    ...
    document.getElementById('sidebarNav').innerHTML=
      ...
      sec('03 资产与账本','asset',[{l:'资产总览',g:'asset',t:'overview'},{l:'APT流水',g:'asset',t:'ledger'},{l:'池子/对账/冲正',g:'asset',t:'pools'},{l:'经济模型总览',g:'asset',t:'econOverview'},{l:'奖励与结算监控',g:'asset',t:'econSettlement'},{l:'经济模型配置入口',g:'asset',t:'econConfig'}])+
      ...
      sec('06 赛事预测','market',[{l:'赛事/竞猜列表',g:'market',t:'list'},{l:'竞猜详情',g:'market',t:'detail'},{l:'参与订单管理',g:'market',t:'orders'},{l:'结果/结算/退款/更正',g:'market',t:'result'},{l:'数据驾驶舱',g:'market',t:'dataCockpit'},{l:'足球数据管理',g:'market',t:'footballData'},{l:'市场赔率数据',g:'market',t:'marketData'},{l:'信号与数据质量',g:'market',t:'signal'}])+
      ...
      sec('08 客服/审计/运维','support',[{l:'全量操作日志',g:'support',t:'audit'},{l:'敏感操作审计',g:'support',t:'sensitiveAudit'},{l:'异步任务/状态',g:'support',t:'ops'},{l:'Provider监控',g:'support',t:'provider'},{l:'数据源管理',g:'support',t:'datasource'},{l:'RBAC角色',g:'support',t:'rbac'},{l:'语言管理',g:'support',t:'lang'},{l:'系统配置',g:'support',t:'config'},{l:'APT Migration',g:'support',t:'migration'}]);
    ...
    lbl['asset:overview']='资产总览';lbl['asset:ledger']='APT流水';lbl['asset:pools']='池子/对账/冲正';lbl['asset:correction']='池子/对账/冲正';lbl['asset:econOverview']='经济模型总览';lbl['asset:econSettlement']='奖励与结算监控';lbl['asset:econConfig']='经济模型配置入口';
    ...
    lbl['market:list']='赛事/竞猜列表';lbl['market:detail']='竞猜详情';lbl['market:orders']='参与订单管理';lbl['market:result']='结果/结算/退款/更正';lbl['market:refund']='结果/结算/退款/更正';lbl['market:dataCockpit']='数据驾驶舱';lbl['market:footballData']='足球数据管理';lbl['market:marketData']='市场赔率数据';lbl['market:signal']='信号与数据质量';
