var App = {
  ...
  tc:function(s){var m={active:'green',completed:'green',pending:'amber',rejected:'red',approved:'blue',draft:'default',open:'blue',locked:'amber',settled:'green',void:'default',closing:'amber',settlement:'amber',high:'red',medium:'amber',low:'green',critical:'red',review:'amber',cooling:'amber',suspended:'red',restricted:'red',analyzing:'amber',escalated:'red',resolved:'green',pending_approval:'amber',changes_requested:'amber',executed:'green',waiting_user:'amber',in_progress:'blue',not_started:'default',needs_info:'amber',disputed:'red',partial:'amber',cancelled:'default',held:'amber',pending_claim:'amber',claimed:'green',expired_returned:'default',failed:'red',running:'blue',scheduled:'amber',pending_confirmation:'amber',normal:'green',elevated:'amber',matched:'green','in':'green',out:'red',awaiting_result:'amber',settling:'amber',refunding:'amber',refunded:'green',correcting:'amber',corrected:'green',submitted:'blue'};return m[s]||'default';},
