...
class ParseCrontab
{
     ...
     */
    public static function parse($crontab_string, $start_time = null,$rtype='second')
    {
        ...
        if(!empty($rtype) && isset($date[$rtype])){
            if (
     ...
     * @return array
     */
    private static function _parseCronNumber($s, $min, $max)
    {
        $result = array();
        $v1 = explode(",", $s);
        foreach ($v1 as $v2) {
