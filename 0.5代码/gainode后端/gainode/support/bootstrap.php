...
set_error_handler(function ($level, $message, $file = '', $line = 0) {
    // PHP 8.3+ 下部分第三方库（如 simplito/bn-php 使用已废弃的 assert_options()/ASSERT_ACTIVE）
    // 会触发 E_DEPRECATED。这类来自 vendor 的废弃警告不由本项目维护，直接静默，
    // 避免刷屏和中断命令行任务（如 webman test）；本项目自身代码的废弃警告仍保留提示。
