...
class ProjectOrderResponse extends Response{
    ...
    protected array $children = [
        'listItem' => ["id","order_no","user_id","project_id","project_name","min_day_rate","max_day_rate","amount","fee","order_status","pay_method","pay_amount","paid_at","settle_amount","settle_cnt","last_settle_time","descr","sort","created_time","updated_time","expires_at","cancel_at","status"],
    ];

    //定义场景
    protected array $scenes = [
        'list'   => ['page', 'size', 'count', 'total_page', 'data'],
        'add'  =>  ["id","order_no","user_id","project_id","project_name","min_day_rate","max_day_rate","amount","fee","order_status","pay_method","pay_amount","paid_at","settle_amount","settle_cnt","last_settle_time","descr","sort","created_time","updated_time","expires_at","cancel_at","status"],
        'update'  =>  ["id","order_no","user_id","project_id","project_name","min_day_rate","max_day_rate","amount","fee","order_status","pay_method","pay_amount","paid_at","settle_amount","settle_cnt","last_settle_time","descr","sort","created_time","updated_time","expires_at","cancel_at","status"],
        'detail'  =>  ["id","order_no","user_id","project_id","project_name","min_day_rate","max_day_rate","amount","fee","order_status","pay_method","pay_amount","paid_at","settle_amount","settle_cnt","last_settle_time","descr","sort","created_time","updated_time","expires_at","cancel_at","status"],
    ];
}
