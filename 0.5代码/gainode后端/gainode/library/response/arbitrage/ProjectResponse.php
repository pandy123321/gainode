...
class ProjectResponse extends Response{
    ...
    protected array $scenes = [
        ...
        'add'  =>  ["id","name","image","project_day","project_rate","project_price","min_day_rate","max_day_rate","user_amount","user_invite","total_cnt","start_date","limit_num","sales_cnt","position_cnt","sort","descr","created_time","updated_time","status"],
        'update'  =>  ["id","name","image","project_day","project_rate","project_price","min_day_rate","max_day_rate","user_amount","user_invite","total_cnt","start_date","limit_num","sales_cnt","position_cnt","sort","descr","created_time","updated_time","status"],
