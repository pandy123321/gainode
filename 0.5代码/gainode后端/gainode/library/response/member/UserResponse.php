...
class UserResponse extends Response{
    ...
    protected array $fields  =   [
		...
		"rewards_cnt"       => ["type" => "integer",   "description"=>"奖励次数"],
