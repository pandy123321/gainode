...
class RechargeOrderResponse extends Response{
    ...
    protected array $children = [
        'listItem' => ["id","order_no","user_id","network","address","from_address","currency","money","reward_money","fee","tx_hash","confirmations","required_confirmations","chain_data","actual_amount","order_status","admin_id","source","descr","created_time","updated_time","credited_time","retry_count","status","user_no"],
    ];
