...
class WithdrawOrderResponse extends Response{
    ...
    protected array $children = [
        'listItem' => ["id","order_no","user_id","type","currency","money","fee","actual_amount","address","risk_score","tx_hash","retry_count","order_status","descr","review_admin_id","created_time","updated_time","approved_time","broadcasted_time","confirmed_time","status","user_no"],
    ];
