...
check(serviceMethodExists(\library\service\admin\AdminOtcTradeDtoService::class, 'list'), 'AdminOtcTradeDtoService::list');
check(serviceMethodExists(\library\service\otc\OtcTradeService::class, 'detail'), 'OtcTradeService::detail');
...
check(serviceMethodExists(\library\service\approval\ApprovalRequestService::class, 'detail'), 'ApprovalRequestService::detail');
check(serviceMethodExists(\library\service\parameter\ParameterReleaseService::class, 'detail'), 'ParameterReleaseService::detail');
...
check(serviceMethodExists(\library\service\admin\AdminPredictionOrderDtoService::class, 'list'), 'AdminPredictionOrderDtoService::list');
check(serviceMethodExists(\library\service\prediction\PredictionMarketService::class, 'detail'), 'PredictionMarketService::detail');
...
check(serviceMethodExists(\library\service\prediction\ResultService::class, 'detail'), 'ResultService::detail');
check(serviceMethodExists(\library\service\admin\AdminSettlementDtoService::class, 'list'), 'AdminSettlementDtoService::list');
check(serviceMethodExists(\library\service\admin\AdminSettlementBatchDtoService::class, 'list'), 'AdminSettlementBatchDtoService::list');
check(serviceMethodExists(\library\service\prediction\SettlementBatchService::class, 'detail'), 'SettlementBatchService::detail');
check(serviceMethodExists(\library\service\prediction\SettlementService::class, 'detail'), 'SettlementService::detail');
check(serviceMethodExists(\library\service\admin\AdminRefundDtoService::class, 'list'), 'AdminRefundDtoService::list');
check(serviceMethodExists(\library\service\admin\AdminCorrectionDtoService::class, 'list'), 'AdminCorrectionDtoService::list');
...
check(serviceMethodExists(\library\service\otc\OtcOrderService::class, 'detail'), 'OtcOrderService::detail');
check(serviceMethodExists(\library\service\risk\RiskCaseService::class, 'detail'), 'RiskCaseService::detail');
check(serviceMethodExists(\library\service\otc\OtcOrderService::class, 'listByUser'), 'OtcOrderService::listByUser');
check(serviceMethodExists(\library\service\prediction\RefundCaseService::class, 'detail'), 'RefundCaseService::detail');
check(serviceMethodExists(\library\service\prediction\CorrectionCaseService::class, 'detail'), 'CorrectionCaseService::detail');
check(serviceMethodExists(\library\service\robot\RobotService::class, 'detail'), 'RobotService::detail');
...
check(serviceMethodExists(\library\service\admin\AdminKycDtoService::class, 'list'), 'AdminKycDtoService::list');
check(serviceMethodExists(\library\service\admin\AdminUserDetailDtoService::class, 'detail'), 'AdminUserDetailDtoService::detail');
