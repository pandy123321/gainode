...
| GAP-004 | ProviderHealth | A-DATA-002 | 05 | Provider 健康指标对象 | 数据源状态监控不可用 | 显示"Runtime Not Available" | BetBurger 合同是否已签 |
...
| GAP-008 | ArbitrageOpportunity | A-DATA-004, A-AI-004 | 05 | 套利机会 Object 定义 | 套利数据和模拟不可用 | 显示"Feature Not Available" | 是否启用套利模拟 |
| GAP-009 | AISignal | A-DATA-005 | 05 | AI 信号 Object 定义 | 信号质量页不可用 | 显示"Developmental Feature" | AI 信号是否生产需求 |
...
| GAP-012 | SimulationRun | A-AI-004 | 05 | 模拟运行 Object 定义 | 策略模拟不可用 | 显示"Theoretical Only" | 模拟运行引擎 |
